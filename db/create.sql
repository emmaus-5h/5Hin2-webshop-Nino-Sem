...
insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id, afmetingen) values ('Fender Legacy Vintage Monogram Strap gitaarband', 'Fender brengt met deze Legacy Vintage Monogram Strap een getrouwe replica uit van een van de bekendste gitaarbanden van het iconische Amerikaanse gitaarmerk. Naast de traditionele kleurencombinatie is er gekozen voor het “straight signature” logo dat dateert uit de gouden jaren van Fender. Deze stijlvolle draagband is opgebouwd uit een polyester basis met een comfortabele onderzijde van synthetisch leer. In combinatie met de leren eindstukken en de kunstmatig verouderde metalen hardware levert dit een betrouwbare gitaarband vol Fender DNA!', '148962', 42, 46, '200 gr.', 6, "verstelbaar tussen 80cm en 140 cm");

  insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id, afmetingen) values ('Fender 351 Material Medley Medium (set van 6 plectrums)', 'Dit setje van zes picks van Fender is geweldig voor iedereen die graag wat variatie in materialen uitprobeert. In deze plectra-pack zitten namelijk zes plectra,  elk gemaakt van een ander populair materiaal. Fender heeft hierbij gekozen voor de fijne selectie van Tortuga, Dura-Tone, Wavelength, Nylon, Classic Celluloid en Premium Celluloid. Allemaal overigens in de veelgebruikte 351 vorm. Deze variant heeft de dikte Medium. ', '41587', 5.99, 7.99, '6 gr.', 6, "n.v.t.");
...
insert into artikel_winkel (product_id, winkel_id) values (17,1);
insert into artikel_winkel (product_id, winkel_id) values (17,2);
insert into artikel_winkel (product_id, winkel_id) values (17,3);
insert into artikel_winkel (product_id, winkel_id) values (17,4);
...
insert into voorraad (artikel_winkel_id ,name) values (61,'Ja');
insert into voorraad (artikel_winkel_id ,name) values (62,'Binnenkort');
insert into voorraad (artikel_winkel_id ,name) values (63,'Nee');
insert into voorraad (artikel_winkel_id ,name) values (64,'Laatste items');
insert into voorraad (artikel_winkel_id ,name) values (65,'Ja');
insert into voorraad (artikel_winkel_id ,name) values (66,'Nee');
insert into voorraad (artikel_winkel_id ,name) values (67,'Nee');
insert into voorraad (artikel_winkel_id ,name) values (68,'Laatste items');
