...
insert into products (name, description, artikelcode, price, adviesprijs, gewicht) values ('Fenton SBS60 Bluetooth-speaker met LED-verlichting', 'Altijd even overal heerlijk genieten van je favoriete muziek, het kan met de Fenton SBS60 Bluetooth speaker. Een mooi vormgegeven compacte speaker die voorzien is van twee 4" full range speakers. Voor een mooie look is de SBS60 voorzien van twee LED strips die hem een stoer uiterlijk geven. Indien gewenst kunnen de LED strips uitgeschakeld worden. Voor het afspelen van muziek via de SBS60 kan gekozen worden uit Bluetooth, de ingebouwde mp3 speler (USB stick of Micro SD kaart) of voor de AUX ingang. Voor deze laatste wordt een kabel meegeleved zodat je je telefoon, tablet of laptop eenvoudig kunt verbinden. Uiteraard ontbreekt ook een oplaadkabel niet zodat je een eventuele lege accu eenvoudig via een USB aansluiting weer op kunt laden.', '4925485', 80, 110, '10 kg');
