...
insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id) values ('Dunlop Max Grip Jazz III Carbon Fiber plectrums (6 stuks)', 'Dunlop combineert de populaire en klassieke Jazz III-vorm met de innovatieve Max Grip technologie. Bij deze set heb je de beschikking over zes robuuste plectrums in de moderne ogende afwerking met de naam Carbon Fiber. Met deze plectra heb je naast extreme duurzaamheid de mogelijkheid om je gitaarspel bijzonder snel en uiterst secuur uit te voeren. In interviews heeft gitarist Mick Thomson van Slipknot laten weten zeer gecharmeerd te zijn van dit type plectrum.', '845874', 3.90, 8.99, '5 gr', 6);

insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id) values ('Simo 5A drumstokken met houten tip
', 'Deze Simo stokken zijn gemaakt van hickory en doen zeker niet onder voor stokken van grote merken. De balans is uitstekend en ze liggen prettig in de hand. Wat betreft diameter, lengte en taper komen deze drumstokken overeen met standaard 5A stokken. De houten tip levert een fraaie, warme, volle attack - met name op bekkens. Fazley levert met deze 5A stokken een prima set met een meer dan uitstekende prijs-kwaliteitsverhouding!', '548587', 4.65, 5.79, '97 gr', 7);

insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id) values ('Simo HH 2038 capo voor klassieke gitaar', 'Voor de gitaristen die op een Spaanse of klassieke gitaar spelen en die wel eens een capodaster willen gebruiken, komt Simo met deze vlakke HH 2038 capo voor dit type nylonsnarige akoestische gitaar. Door de stevige veer is hij gemakkelijk te plaatsen en de solide constructie zorgt dat hij goed op zijn plek blijft zitten. Niet alleen de snaren hebben overigens profijt van een siliconen demper, maar ook aan de achterkant van de hals heeft deze kapodastro een beschermlaag van ditzelfde materiaal. Doordat de eerdergenoemde demper vlak is, is deze Simo capo overigens alleen met een platte toets te gebruiken.', '548587', 8.50, 9.99, '60 gr', 6);

insert into products (name, description, artikelcode, price, adviesprijs, gewicht, productgroep_id) values ('Innox ISA 01 MKII muziekstandaard met geperforeerd blad', 'De eerste Innox ISA 01 muziekstandaard stond als een huis en liep als een trein. Maar zoals dat met alles gaat: vroeg of laat zie je dingen die beter kunnen, en dan breng je een nieuwe versie uit. De Innox ISA 01 MKII is die nieuwe versie. In deze MK2 krijg je een handige aandraaiknop om het lessenaarblad vast te zetten; een uitkomst voor mobiel gebruik! Verder is de MK2 over de gehele linie gewoon net even wat degelijker, het is simpelweg een beter statief geworden. Voor de rest nog steeds de vertrouwde aanblik van het geperforeerde blad. Voor thuis en onderweg is dit kortom een oerdegelijk product dat je als muzikant eigenlijk gewoon moet hebben.', '548587', 39.99, 46.99, '3 kg', 8);
