...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.artikelcode AS code, products.price AS price, products.adviesprijs AS adviesprijs, products.gewicht AS gewicht, products.afmetingen AS afmetingen, (SELECT voorraad.name FROM artikel_winkel JOIN winkels ON winkels.id = Artikel_winkel.winkel_id JOIN voorraad ON voorraad.artikel_winkel_id = Artikel_winkel.id WHERE artikel_winkel.product_id = products.id and winkels.id = 1) AS voorraadrotterdam, (SELECT voorraad.name FROM artikel_winkel JOIN winkels ON winkels.id = Artikel_winkel.winkel_id JOIN voorraad ON voorraad.artikel_winkel_id = Artikel_winkel.id WHERE artikel_winkel.product_id = products.id and winkels.id = 2) AS voorraadutrecht, (SELECT voorraad.name FROM artikel_winkel JOIN winkels ON winkels.id = Artikel_winkel.winkel_id JOIN voorraad ON voorraad.artikel_winkel_id = Artikel_winkel.id WHERE artikel_winkel.product_id = products.id and winkels.id = 3) AS voorraadamsterdam, (SELECT voorraad.name FROM artikel_winkel JOIN winkels ON winkels.id = Artikel_winkel.winkel_id JOIN voorraad ON voorraad.artikel_winkel_id = Artikel_winkel.id WHERE artikel_winkel.product_id = products.id and winkels.id = 4) AS voorraadonline  FROM products WHERE id = ?')
